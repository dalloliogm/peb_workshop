...
Let's create a nicer plot, in which we color by the population variable, also set limits for the Y axes, and use a whiter plot theme.

```{r}

ggplot(peb.long, aes(x=overexpressed, y=expression, color=population)) +
  geom_boxplot() + 
